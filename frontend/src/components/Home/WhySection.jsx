...
const WhySection = () => {
  ...
  return (
    <section className="flex flex-col bg-stone-100 items-center w-full px-6 border-y border-gray-200 py-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mt-10 w-full max-w-330">
        {featuresData.map((feature, index) => (
          <div key={index} className="h-full">
            <div className="h-full p-8 rounded-2xl border shadow-sm hover:shadow-lg  border-gray-200  bg-white/30 flex flex-col hover:-translate-y-2 transition-all duration-300 gap-2">
              {feature.icon}
