    ...
    <div className="relative h-[80vh] overflow-hidden">
      ...
      <div className="absolute w-full inset-0 pt-45 flex items-center justify-center px-6 md:px-12 lg:px-24">
        <div className="max-w-2xl text-center text-white">
          ...
          <Link to="/collections">
            <button className="mt-4 bg-transparent border-2 border-white px-6 py-3 sm:px-8 sm:py-3 text-sm sm:text-base font-light transition cursor-pointer uppercase hover:bg-white hover:text-black hover:border-white">
              Shop Collection
            </button>
          </Link>
        </div>
