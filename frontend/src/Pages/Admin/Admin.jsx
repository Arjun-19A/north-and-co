    ...
    <section className="space-y-8 lg:space-y-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 lg:gap-6">
        {stats.map((item) => (
          <div
            key={item.title}
            className="bg-white border border-gray-300 p-6 lg:p-7"
          >
            ...
            <h2 className="mt-5 lg:mt-6 text-3xl lg:text-4xl font-light wrap-break-word">
              {item.value}
            </h2>
          </div>
        ))}
      ...
      <div className="bg-white border border-gray-300">
        ...
        <div className="px-5 lg:px-8 py-6 lg:py-8 grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-10">
          <SummaryItem
          ...
          <SummaryItem label="Orders Received" value={dashboard?.orders ?? 0} />
...
function SummaryItem({ label, value }) {
  return (
    <div>
      <p className="text-sm text-black/45 mb-2">{label}</p>

      <h3 className="text-3xl lg:text-4xl font-light wrap-break-word">
        {value}
      </h3>
    </div>
  );
