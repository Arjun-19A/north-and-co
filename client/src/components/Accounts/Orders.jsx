...
const Orders = () => {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      {orders.length === 0 ? (
        <div className="border border-gray-300 py-20 px-8 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col gap-3">
          {orders.map((order) => (
            <div key={order._id} className="border border-gray-300">
              <div className="flex items-center justify-between py-5 px-5 gap-4 flex-wrap">
                <div>
