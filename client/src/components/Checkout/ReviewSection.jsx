  ...
  return (
    ...
    ${
      completed
        ...
        >
          {completed ? <IoCheckmark size={14} /> : step}
        </div>
      ...
      <div className="flex-1 pl-7 md:pl-8">
          ...
          {isOpen && (
            <>
              ...
              <button
                ...
                disabled={loading}
                className="w-full md:w-auto bg-black text-white px-2 py-4 text-xs uppercase tracking-[0.2em] font-light hover:opacity-80 transition-opacity disabled:opacity-60 disabled:cursor-not-allowed text-[12px]  duration-200"
              >
