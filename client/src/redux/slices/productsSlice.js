  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchBestSellerProducts.pending, (state) => {
        state.loading.bestSeller = true;
        state.error.bestSeller = null;
      })

      .addCase(fetchBestSellerProducts.fulfilled, (state, action) => {
        state.loading.bestSeller = false;
        state.bestSellerProducts = action.payload;
      })

      .addCase(fetchBestSellerProducts.rejected, (state, action) => {
        state.loading.bestSeller = false;
        state.error.bestSeller =
          action.payload?.message || "Failed to load best sellers";
      });
  },
});

export const { setFilters, clearFilters, changePage } = productsSlice.actions;
